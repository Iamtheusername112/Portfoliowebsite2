      ...
      <div className="h-screen flex items-center justify-center">
        ...
        >
          ...
          <p className="text-light text-xl my-8">
            Eager IRONHACK boot camp graduate, skilled in full stack web
            development, seeks to join a dynamic team. Proficient in front end
            and back end technologies, I m excited to create user friendly web
            applications and contribute collaboratively.
          </p>
